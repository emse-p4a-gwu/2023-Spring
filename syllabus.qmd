...
As you gain more experience programming, AIs will become an incredibly useful tool. They can generate templates for things you are trying to build, and they can help you identify bugs in your code. However, for this class, the use of AIs for homework assignments is not permitted. In this course, we are building foundational skills in computational thinking, and the best way to build those skills is to write the code on your own. In the follow-on course to this one ([EMSE 4572: Exploratory Data Analysis](https://eda.seas.gwu.edu/)), the use of AI engines will be allowed to support your projects.
