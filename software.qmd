...
1. Sign up for [Slack]({{< var slack >}}). You should have been sent an email invitation to join. If not, you can find a sign up link on the announcement in Blackboard. Use your `@gwu.edu` email to sign up.
...
3. [Download and install R](https://cloud.r-project.org) (version 4.0.2 or higher).

4. [Download and install RStudio](https://rstudio.com/products/rstudio/download/) (Free desktop version).
