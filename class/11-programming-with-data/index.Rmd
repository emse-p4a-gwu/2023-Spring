...
Write the function `filtered_cols` which plots a bar chart based on a condition, then use it for the two examples below. 

```{r}
#| eval: false

filtered_cols <- function(df, condition, x, y)
```
