...
.leftcol30[.circle[
<img src="images/lujin.jpg" width="300">
]]
...
.leftcol30[.circle[
<img src="images/michael.png" width="300">
]]
...
- EMSE Junior & P4A alumni (Fall 2020)
]
...
### https://p4a.seas.gwu.edu/2022-Spring/
...
# Homeworks (55% of grade)

--

## `r fa('calendar')` ~Every week (12 total)

--

## `r fa('clock')` Soft due dates (11:59pm Wed. before class)

--

## `r fa('exclamation')` **Don't abuse this flexibility**
...
### - Contact me for special cases (I'm expecting a lot of these)
...
## `r fa('clock')` ~5 minutes (1-3 questions)
...
## `r fa('calendar')` Midterm (weeks 1 - 7) on March 10

## `r fa('calendar')` Final (weeks 1 - 13) on May 05
...
## `r fa('slack')` Use [Slack](https://emse-p4a-s22.slack.com/) to ask questions.
